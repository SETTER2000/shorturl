// ВОТ от сюда
// https://k6.io/docs/examples/functional-testing/#sample-integration-test
// Пример интеграционного теста
// Этот тест проходит в несколько этапов. Он создает новую учетную запись пользователя,
// выполняет аутентификацию и взаимодействует с защищенными ресурсами.
import chai, {describe, expect} from 'https://jslib.k6.io/k6chaijs/4.3.4.3/index.js';
import {Get, Httpx} from 'https://jslib.k6.io/httpx/0.0.6/index.js';
