...
type (
	...
	HTTP struct {
		...
		ServerAddress string `env-required:"true" env:"SERVER_ADDRESS" yaml:"server_address,omitempty"`
		ServerHost    string `env-required:"true" env:"SERVER_HOST" yaml:"server_host,omitempty"`
	}
